const { relPath, readFileAsync, calcAssetPath, log, logv } = require('../../../utils/utils.js')
...
const babelPresets = {
  ...
  transpileModern: [[ require.resolve('@babel/preset-env'), { modules: false, targets: { chrome: 61, safari: '10.1', ios_saf: '10.3', edge: 16 } }]],
