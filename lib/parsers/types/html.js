...
/** @type {(doc: any, dir: string) => Promise<any>} */
...
/** @type {(doc: any, currentEnv: string) => Promise<void>} */
...
/** @type {(doc: parse5.Node, filename: string, config: Webo.Config, htmlRefs: any) => Promise<void>} */
