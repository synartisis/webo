...
//     async load() {
// if (this.path !== 'src/client/landing/index.js') return { deps: [], load: () => null}
...
//       if (!cache.has(this.path)) console.log('NOT CACHED') && cache.set(this.path, null)
// if (this.path === 'src/client/landing/index.js') log('VERBOSE', 'TIMESTAMP', 'JS_LOADER - rollup1', this.path)
...
//           hypothetical({ files: require('../files').filesFlat(), allowRealFiles: true }),
...
// if (this.path === 'src/client/landing/index.js') log('VERBOSE', 'TIMESTAMP', 'JS_LOADER - rollup1.1', this.path)
...
//           })
//         )
// if (this.path === 'src/client/landing/index.js') log('VERBOSE', 'TIMESTAMP', 'JS_LOADER - rollup2', this.path)
...
//         })
//       }
// if (this.path === 'src/client/landing/index.js') log('VERBOSE', 'TIMESTAMP', 'JS_LOADER - rollup3', this.path)
