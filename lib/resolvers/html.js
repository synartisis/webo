...
module.exports = async filename => {
  try {
    ...
    let assets = [
      ...[... document.querySelectorAll('script[src]:not([type="module"])')].map(o => createDep(filename, o.src, 'script', filename)),
      ...[... document.querySelectorAll('script[src][type="module"]')].map(o => createDep(filename, o.src, 'module', filename)),
      ...[... document.querySelectorAll('link[rel="stylesheet"]')].map(o => createDep(filename, o.href, 'css', filename)),
      ...[... document.querySelectorAll('img[src]')].map(o => createDep(filename, o.src, 'img', filename)),
    ]
