...
module.exports = async function dev({ type, entry, srcRoot, staticRoots, serverRoot, parserOptions }) {

  const webSocketPort = calcUniquePort()
  await bus.memfsInit({ mode: 'dev', srcRoot, staticRoots, serverRoot, parserOptions, watch: true, webSocketPort })
